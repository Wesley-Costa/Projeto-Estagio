            ...
            <div class="container">
                ...
                @if (Session::has('mensagem'))
                    <div class="alert alert-danger alert-dismissible">
                        <!-- data-dismiss - class para fechar o button que abrir sem precisar de nada  -->
                        <button type="button" class="close" data-dismiss="alert">x</button>
                        <h5><i class="icon fas fa-ban"></i>Atenção!</h5>
                        {{ Session::get('mensagem') }}
                    </div>
                @endif
                <form action='/clientes' id="cadCliente" method='POST'>
                    @csrf
                    <div class="form-row">
                ...
                @error('nome') is-invalid @enderror"
                        ...
                        <div>
                            <button type="submit" form="cadCliente" class="btn btn-info float-right"
