...
**Banco de Dados**
    - As configurações do banco ficam na pasta config, onde é possivel acessar a partir do arquivo databases.php
    - Quanto a criação das tabelas, elas são criadas utilizando as chamadas migrations, e assim como em outros frameworks, o Laravel utiliza as migrations para criar toda estruturação das tabelas do banco.
    - Para criar as tabelas no banco e assim consolidar a estrutura feita nas migrations devemos executar o seguinte comando:
        - $ php artisan migrate
